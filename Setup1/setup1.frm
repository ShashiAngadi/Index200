...
'
    ...
    ShowStaticMessageDialog "Checking for previous inatallation if any"
    ...
    ShowStaticMessageDialog "Get the database information"
    
    'now get the information about the Serever or client
    SetMousePtr vbDefault
    If ShowServerComponent Then
        'here get the data base path to store the datadase
        ShowPathDialog gstrDIR_DB
    End If
    ...
    'INdex 2000  WAVES
    'Here get the Back up path for the database
    If gboolServer Then
        Call PauseApplication(1)
        'now Get the  infromation about data back up
        ShowPathDialog gstrDIR_Back
    End If
    
    'Here Register the index 2000
    
    Call RegisterIndex2000
