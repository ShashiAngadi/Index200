...
Begin VB.Form frmTransferNew 
   ...
   Begin VB.Frame fra 
      ...
      End
   End
   Begin ComctlLib.TabStrip tabTransfer 
      Height          =   5895
      Left            =   120
      TabIndex        =   31
      Top             =   120
...
gDbTrans.SqlStmt = " SELECT MAX(TransDate) as MaxTransDate FROM Stock"
...
tabTransfer.Tabs(1).Caption = GetResourceString(38)
tabTransfer.Tabs(2).Caption = GetResourceString(38, 295)

lblTransferDate.Caption = GetResourceString(37)

optFrom.Caption = GetResourceString(107)
optTo.Caption = GetResourceString(108)

lblBranch.Caption = GetResourceString(210)
...
lblProductName.Caption = GetResourceString(158, 35) _
                         & " " & GetResourceString(27)
lblQuantity.Caption = GetResourceString(306)
lblProductName.Caption = GetResourceString(215)
lblQuantity.Caption = GetResourceString(306)
...
cmdRefresh.Caption = GetResourceString(32)

cmdTab1Show.Caption = GetResourceString(13)
...
With grd(TRANSFER_SHOW)
    ...
    .Col = 0: .Text = GetResourceString(33): .CellFontBold = True 'Sl
    .Col = 1: .Text = GetResourceString(37): .CellFontBold = True
    .Col = 2: .Text = GetResourceString(227): .CellFontBold = True
    .Col = 3: .Text = GetResourceString(295): .CellFontBold = True
    .Col = 4: .Text = GetResourceString(306): .CellFontBold = True
    .Col = 5: .Text = GetResourceString(42): .CellFontBold = True
End With
...
With grd(TRANSFER_TRANSACTION)
    ...
    .FixedRows = 1
    .Row = 0
    .Col = 0: .Text = GetResourceString(227): .CellFontBold = True  '"Branch Name"
    .Col = 1: .Text = GetResourceString(295): .CellFontBold = True '"Description"
    .Col = 2: .Text = GetResourceString(306): .CellFontBold = True 'Quantity
    .Col = 3: .Text = GetResourceString(42): .CellFontBold = True 'Balance
End With
