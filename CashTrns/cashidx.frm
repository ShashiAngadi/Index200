...
Public Property Let ExpectedCash(NewValue As Currency)
    txtExpectedCash = FormatCurrency(NewValue)
End Property
...
Call AllowKeyAscii(txtCashIn(Index), "1234567890" & Chr(8) & " & Chr(22) & " & Chr(3), KeyAscii, False)
...
Call AllowKeyAscii(txtCashOut(Index), "1234567890" & Chr(8), KeyAscii, False)
