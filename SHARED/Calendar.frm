...
Private Sub Calendar1_DblClick()
    ...
    m_SelDate = GetIndianDate(Calendar1.Value)
...
If Left + Width > Screen.Width - 25 Then _
                        Left = Left - Width

If Top + Height > Screen.Height - 25 Then _
                        Top = Top - Height
...
Public Property Get selDate() As String
    selDate = m_SelDate 'IIf(m_SelDate = "", m_SelDate, FormatDate(m_SelDate))
End Property
Public Property Let selDate(ByVal vNewValue As String)
'Validate the Date Format
    If DateValidate(vNewValue, "/", True) Then
        Calendar1.Value = GetSysFormatDate(vNewValue)
    End If
End Property
