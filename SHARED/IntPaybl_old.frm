...
For Each ctrl In Me
    ...
    End If
Next ctrl
lblCustTitle.Caption = LoadResString(gLangOffSet + 446) & " " & LoadResString(gLangOffSet + 35)
...
If Val(txtBox) > 0 Then
    txtAmount(txtAmount.Count - 1) = FormatCurrency(Val(txtAmount(txtAmount.Count - 1).Tag) - _
...
Public Property Let Cumulative(ByVal vNewValue As Boolean)
    m_Cumulative = vNewValue
End Property
